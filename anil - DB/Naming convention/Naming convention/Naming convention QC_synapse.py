...
dim_country_synapse = jdbc_connection_synapse('mm.vw_gpd_dim_country')
dim_product_synapse = jdbc_connection_synapse('mm.vw_gpd_dim_product')
...
keys = ['campaign_type', 'campaign_market', 'campaign_subproduct', 'segment', 'region', 'portfolio', 'business_channel', 'media_channel', 'media_objective', 'start']
...
dim_campaign_synapse = dim_campaign_synapse.withColumn("campaign_type", preproc_udf(col("campaign_type"))).withColumn("campaign_market", preproc_udf(col("campaign_market"))).withColumn("campaign_subproduct", preproc_udf(col("campaign_subproduct"))).withColumn("segment", preproc_udf(col("segment"))).withColumn("region", preproc_udf(col("region"))).withColumn("portfolio", preproc_udf(col("portfolio"))).withColumn("business_channel", preproc_udf(col("business_channel"))).withColumn("media_channel", preproc_udf(col("media_channel"))).withColumn("media_objective", preproc_udf(col("media_objective"))).withColumn("start", preproc_udf(col("start")))
...
# comapring table values and valid set

dim_campaign_synapse_NC = dim_campaign_synapse.withColumn(
    "campaign_type_NC", 
    when((col("campaign_type").isin(result_dict['campaign_type'])) & (col('campaign_market').isin(result_dict['campaign_market'])) & (col("campaign_subproduct").isin(result_dict['campaign_subproduct'])) & (col("segment").isin(result_dict['segment'])) & (col("region").isin(result_dict['region'])) & (col("portfolio").isin(result_dict['portfolio'])) & (col("business_channel").isin(result_dict['business_channel'])) & (col("media_channel").isin(result_dict['media_channel'])) & (col("media_objective").isin(result_dict['media_objective'])) & (col("start").isin(result_dict['start'])), 0).otherwise(1)
)
dim_campaign_synapse_NC.display()

# COMMAND ----------

# MAGIC %md
# MAGIC ### gpd dim media_buy
# MAGIC
...
# MAGIC %md
# MAGIC ### need to change below 3 cells according to new tables
...
values = [language_list,buying_type_list,costing_model_list ,mediabuy_campaign_type_list ,audience_type_list ,audience_desc_list ,data_type_list ,optimisation_list ,placement_type_list ,mediabuy_format_list ,device_list ,mediabuy_ad_tag_size_list ,mediabuy_ad_tag_size_list ,mediabuy_market_list ,mediabuy_subproduct_list ,strategy_list ,mediabuy_platform_list ,mediabuy_partner_list ,mediabuy_objective_list ,mediabuy_dimensions_list ]
...
def preproc(x):
    return (''.join(c for c in x if c.isalnum())).lower()
preproc_udf = udf(preproc, StringType())
dim_campaign_synapse = dim_campaign_synapse.withColumn("language", preproc_udf(col("language"))).withColumn("buying_type", preproc_udf(col("buying_type"))).withColumn("costing_model", preproc_udf(col("costing_model"))).withColumn("mediabuy_campaign_type", preproc_udf(col("mediabuy_campaign_type"))).withColumn("audience_type", preproc_udf(col("audience_type"))).withColumn("audience_desc", preproc_udf(col("audience_desc"))).withColumn("data_type", preproc_udf(col("data_type"))).withColumn("optimisation", preproc_udf(col("optimisation"))).withColumn("placement_type", preproc_udf(col("placement_type"))).withColumn("mediabuy_format", preproc_udf(col("mediabuy_format"))).withColumn("device", preproc_udf(col("device"))).withColumn("mediabuy_ad_tag_size", preproc_udf(col("mediabuy_ad_tag_size"))).withColumn("mediabuy_market", preproc_udf(col("mediabuy_market"))).withColumn("mediabuy_subproduct", preproc_udf(col("mediabuy_subproduct"))).withColumn("strategy", preproc_udf(col("strategy"))).withColumn("mediabuy_platform", preproc_udf(col("mediabuy_platform"))).withColumn("mediabuy_partner", preproc_udf(col("mediabuy_partner"))).withColumn("mediabuy_objective", preproc_udf(col("mediabuy_objective"))).withColumn("mediabuy_objective", preproc_udf(col("mediabuy_objective"))).withColumn("mediabuy_dimensions", preproc_udf(col("mediabuy_dimensions")))
...
dim_campaign_synapse_NC = dim_campaign_synapse.withColumn(
    "campaign_type_NC", 
    when((col("language").isin(mediaBuy_dict['language'])) & (col('buying_type').isin(mediaBuy_dict['buying_type'])) & (col("costing_model").isin(mediaBuy_dict['costing_model'])) & (col("mediabuy_campaign_type").isin(mediaBuy_dict['mediabuy_campaign_type'])) & (col("audience_type").isin(mediaBuy_dict['audience_type'])) & (col("audience_desc").isin(mediaBuy_dict['audience_desc'])) & (col("data_type").isin(mediaBuy_dict['data_type'])) & (col("optimisation").isin(mediaBuy_dict['optimisation'])) & (col("placement_type").isin(mediaBuy_dict['placement_type'])) & (col("mediabuy_format").isin(mediaBuy_dict['mediabuy_format'])) &
...
# feature_message -- no values for this column
...
# creative_campaign_desc_free_field - no values for that column
...
def preproc(x):
    return (''.join(c for c in x if c.isalnum())).lower()
preproc_udf = udf(preproc, StringType())
dim_creative_synapse = dim_creative_synapse.withColumn("campaign_type", preproc_udf(col("campaign_type"))).withColumn("campaign_market", preproc_udf(col("campaign_market"))).withColumn("campaign_subproduct", preproc_udf(col("campaign_subproduct"))).withColumn("segment", preproc_udf(col("segment"))).withColumn("region", preproc_udf(col("region"))).withColumn("portfolio", preproc_udf(col("portfolio"))).withColumn("business_channel", preproc_udf(col("business_channel"))).withColumn("media_channel", preproc_udf(col("media_channel"))).withColumn("media_objective", preproc_udf(col("media_objective"))).withColumn("start", preproc_udf(col("start")))
...
dim_creative_synapse_NC = dim_creative_synapse.withColumn(
    "creative_NC", 
    when((col("creative_variant").isin(creative_dict['creative_variant'])) & (col('creative_type').isin(creative_dict['creative_type'])) & (col("ad_tag_size").isin(creative_dict['ad_tag_size'])) & (col("dimension").isin(creative_dict['dimension'])) & (col("cta").isin(creative_dict['cta'])) & (col("landing_page").isin(creative_dict['landing_page'])) & (col("creative_market").isin(creative_dict['creative_market'])) & (col("creative_subproduct").isin(creative_dict['creative_subproduct'])) & (col("creative_language").isin(creative_dict['creative_language'])) & (col("creative_platform").isin(creative_dict['creative_platform'])) & (col("creative_partner").isin(creative_dict['creative_partner'])) & (col("creative_campaign_type").isin(creative_dict['creative_campaign_type'])) & (col("creative_audience_type").isin(creative_dict['creative_audience_type'])) & (col("creative_audience_desc").isin(creative_dict['creative_audience_desc'])), 0).otherwise(1)
)
dim_creative_synapse_NC.display()
...
campaign_type_list = [item.strip() for item in 'campaign_type_list, campaign_market_list, campaign_subproduct_list, segment_list, region_list, portfolio_list, business_channel_list, media_channe_list, media_objective_list, start_list'.split(', ')]
...
print(result_dict['campaign_type'])
