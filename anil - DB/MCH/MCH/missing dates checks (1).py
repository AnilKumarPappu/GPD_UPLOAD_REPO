...
df_fact_performance_synapse.filter(col('country_id')=='SA').filter(col('date').isin('20220604',
'20220605',
'20220606',
'20220607',
'20220608',
...
df_fact_performance_synapse.filter(col('country_id')=='US').filter(col('date').isin('20230624',
'20230917',
'20230319',
'20230321',
'20230427',
...
df_fact_performance_synapse.filter(col('country_id')=='EG').filter(col('date').isin('20231002',
'20231001',
'20230930',
'20230929',
'20230928',
...
df_fact_performance_synapse.filter(col('country_id')=='CA').filter(col('date').isin('20230108')).display()
...
df_fact_performance_synapse.filter(col('country_id')=='AE').filter(col('date').isin('20221106',
'20230203',
'20230101',
'20230201',
'20230910',
