...
# MAGIC %md
# MAGIC ### B. Data for fact tables should be available in all dim_tables
# MAGIC
...
# df_fact_performance.join(dim_product, on = "product_id", how = 'left_anti').select("product_id").distinct().join(dim_product, on = "product_id", how = 'left').display()
...
# MAGIC %md
# MAGIC ### 2. Reach frequency in data should match with calculated frequency
...
# MAGIC %md
# MAGIC ### 3. For all campaigns, campaign_platform start and end dates must fall b/w campaign start and end date of each campaign<br>
...
# MAGIC %md
# MAGIC ### 4. There should not be a High Variance b/w Actual and Planned Spend for countries
...
# MAGIC %md
# MAGIC ### 5. The Planned Spend LC/USD ratio should be similar to Actual Spend LC/USD ratio, to show consistent currency conversion
...
# MAGIC %md
# MAGIC ### 6. Check null in Brand, Region
...
# MAGIC %md
# MAGIC ### 8. Spend shouldn't be 0 at year level
...
# MAGIC %md
# MAGIC ### 9.Brand level Categorization for campaign_desc Naming convensin taxonomy Checks.
...
# MAGIC %md
# MAGIC ### 10 . All In_platform_reach and frequency metrics available for all "reach" and "awareness" campaigns in fact_reach
...
# MAGIC %md
# MAGIC ### 11.planned spend data available for how many campaigns vs not 
...
# MAGIC %md
# MAGIC ### 12. List of video campaigns where video views are 0 
...
# MAGIC %md
# MAGIC ### 13. All Reach Metric available for each row in Reach table
...
# MAGIC %md
# MAGIC ### 14. One campaign found in multiple countries
...
# MAGIC %md
# MAGIC ### 15. Wrong campaign_desc to country mapping
...
# MAGIC %md
# MAGIC ### 16. To check the 2022 and 2023 data with the next historical reload 
